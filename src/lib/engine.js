import { layersNeedLogic, collisionsNeedLogic, R } from './renders/renderCanvas'
import { A } from './audio/audioWeb'
...
class Engine {
  ...
  async load () {
    ...
    this.createSprite('mouse-pointer', this.render.mouseLogic(this.render, this))
